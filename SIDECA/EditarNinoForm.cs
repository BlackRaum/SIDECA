...
namespace SIDECA
{
    public partial class EditarNinoForm : Form
    {
        private NinoBusiness ninoBusiness;
        
        public EditarNinoForm(int cedula)
        {
            InitializeComponent();
            ...
            {
                tbxCedulaMenor.Text = nino.CedulaNino + "";
                tbxCedulaMenor.Enabled = false;
                tbxNombreMenor.Text = nino.NombreNino;
                tbxCedulaEncargado.Text = nino.CedulaEncargado + "";
                tbxNombreEncargado.Text = nino.NombreEncargado;
                cbxGenero.SelectedIndex = nino.Sexo == 'f' ? cbxGenero.Items.IndexOf("Femenino") : cbxGenero.Items.IndexOf("Masculino");
                dtpFechaNacimiento.Value = nino.FechaNacimiento;                
            }
        }
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            ...
            if (formularioCorrecto)
            {
                ...
                try
                {
                    this.ninoBusiness.ActualizarNino(nino);
                }
